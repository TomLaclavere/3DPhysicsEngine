...
TEST(SphereTest, SpherePlaneCollision)
{
    ...
    EXPECT_FALSE(sphereZeroRadiusOutside.checkCollision(plane));
}
...
TEST(SphereTest, CheckCollision_DefaultCase)
{
    Sphere      sphere(Vector3D(0_d, 0_d, 0_d));
    DummyObject dummy;

    bool result = sphere.checkCollision(dummy);

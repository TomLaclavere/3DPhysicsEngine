...
//  Format
// --------------------------------------------------------------------------
TEST(Vector3D_Test, FormatVector)
{
    Vector3D    v(1_d, 2_d, 3_d);
    ...
    EXPECT_EQ(s.front(), '(');
    EXPECT_EQ(s.back(), ')');
    EXPECT_NE(s.find("1.000e+00"), std::string::npos);
    EXPECT_NE(s.find("2.000e+00"), std::string::npos);
    EXPECT_NE(s.find("3.000e+00"), std::string::npos);
}
